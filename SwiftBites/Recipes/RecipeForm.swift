...
struct RecipeForm: View {
    ...
    func save() {
        ...
        do {
            switch mode {
            case .add:
                context.insert(Recipe(name: name, summary: summary, category: category, serving: serving, time: time, ingredients: ingredients, instructions: instructions, imageData: imageData))
            case .edit(let recipe):
                recipe.name = name
